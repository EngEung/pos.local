...
class AppConstant extends CApplicationComponent {
	...
	const FILE_TYPE_AUDIO = "FILE_TYPE_AUDIO";
	const FILE_TYPE_VIDEO = "FILE_TYPE_VIDEO";
	const FILE_TYPE_EXCEL = "FILE_TYPE_EXCEL";
	const FILE_TYPE_WORDS = "FILE_TYPE_WORDS";
	const FILE_TYPE_PDF = "FILE_TYPE_PDF";
	const FILE_TYPE_POWER_POINT = "FILE_TYPE_POWER_POINT";
	#
	# File upload types 
	#
	const FILE_UPLOAD_TYPE_RESPONDENT = "FILE_UPLOAD_TYPE_RESPONDENT";
	const FILE_UPLOAD_TYPE_URBAN_VIEWERSHIP = "FILE_UPLOAD_TYPE_URBAN_VIEWERSHIP";
	const FILE_UPLOAD_TYPE_RURAL_VIEWERSHIP = "FILE_UPLOAD_TYPE_RURAL_VIEWERSHIP";
	
	#
	# Question types 
	#
	const QUESTION_TYPE_MULTIPLE_CHOICES = "QUESTION_TYPE_MULTIPLE_CHOICES";
	const QUESTION_TYPE_MULTIPLE_TRUE_OR_FALSE = "QUESTION_TYPE_MULTIPLE_TRUE_OR_FALSE";
	const QUESTION_TYPE_FILL_IN_THE_BLANK = "QUESTION_TYPE_FILL_IN_THE_BLANK";
	const QUESTION_TYPE_REQUIRED_WRITTEN_EXPLANATION = "QUESTION_TYPE_REQUIRED_WRITTEN_EXPLANATION";
	const QUESTION_TYPE_MULTIPLE_WITH_MULTILE_ANSWERS = "QUESTION_TYPE_MULTIPLE_WITH_MULTILE_ANSWERS";
	const QUESTION_TYPE_MATCHING = "QUESTION_TYPE_MATCHING";
	
	#Quesitonnaire Types
	
	const QUESTIONNAIRE_TYPE_RURAL ="QUESTIONNAIRE_TYPE_RURAL";
	const QUESTIONNAIRE_TYPE_URBAN = "QUESTIONNAIRE_TYPE_URBAN";
	
	# Controlls	
	/*RadioButtionList*/
	const CONTROLL_QUESTION_TYPE_MULTIPLE_CHOICES = 'rbl';
	const CONTROLL_QUESTION_TYPE_MULTIPLE_TRUE_OR_FALSE = 'rbl';
	const TEXTBOX = "TextBox";
	const RADIOBUTTONLIST = "RadioButtonList";
	const CHECKBUTTONLIST = "CheckButtonList";
	const TEXTAREA = "TextArea";
	
	/*CheckBoxList*/
	const CONTROLL_QUESTION_TYPE_MULTIPLE_WITH_MULTILE_ANSWERS = 'cbl';
	/*TextArea*/
	const CONTROLL_QUESTION_TYPE_FILL_IN_THE_BLANK = 'ta';
	const CONTROLL_QUESTION_TYPE_REQUIRED_WRITTEN_EXPLANATION = 'ta';
	/*TextBox*/
	 ...
	 *Sections
	 */
	 const SCREENING_RECRUITMENT_SECTION = "SCREENING_RECRUITMENT_SECTION";
	 const TELEVISION_SECTION = "TELEVISION_SECTION";
	 const RADIO_SECTION = "RADIO_SECTION";
	 const NEWSPAPER_SECTION = "NEWSPAPER_SECTION";
	 const MAGAZINE_SECTION = "MAGAZINE_SECTION";
	 const INTERNET_SECTION = "INTERNET_SECTION";
	 const OUTDOOR_ADVERTISING_SECTION = "OUTDOOR_ADVERTISING_SECTION";
	 const UNAID_RECAL_OF_TV_ADS_SECTION = "UNAID_RECAL_OF_TV_ADS_SECTION";
	 const DEMOGRAPHIC_PROFILE_SECTION = "DEMOGRAPHIC_PROFILE_SECTION";
	 const MOBILE_PHONE_SECTIO = "MOBILE_PHONE_SECTION";
	 const OTHERS_SECTION = "OTHERS_SECTION";
	 const INTRODUCTION_SECTION = "INTRODUCTION";
	 
	 /**
	  * Question Answer Type
	  */
	 const QUESTION_ANSWER_TYPE_MULTIPLE_CHOICES = "ANSWER_TYPE_MULTIPLE_CHOICES";
	 const QUESTION_ANSWER_TYPE_MULTIPLE_TRUE_OR_FALSE = "ANSWER_TYPE_MULTIPLE_TRUE_OR_FALSE";
	 const QUESTION_ANSWER_TYPE_FILL_IN_THE_BLANK = "ANSWER_TYPE_FILL_IN_THE_BLANK";
	 const QUESTION_ANSWER_TYPE_REQUIRED_WRITTEN_EXPLANATION = "ANSWER_TYPE_REQUIRED_WRITTEN_EXPLANATION";
	 const QUESTION_ANSWER_TYPE_SIMPLE = "ANSWER_TYPE_SIMPLE";
}
